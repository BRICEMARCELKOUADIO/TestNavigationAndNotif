...
{
    public class GolViewModel : ViewModelBase
    {
        ...
        public GolViewModel(INavigationService navigationService, IEventAggregator ea) : base(navigationService)
        {
            _ea = ea;
            Initialize();
        }
        ...
        protected void Initialize()
        {
            ...
            {
                new SlideItem() { Icon ="icon-insurance",  PrimayText =TranslateManagerHelper.Convert("taxes").ToUpperInvariant(), Url="" }             
            };
            IsLoading = false;
        }
