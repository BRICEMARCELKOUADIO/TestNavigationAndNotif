...
namespace Kola.Starting.ViewModels
{
    public class OthersViewModel : ViewModelBase
    {
        ...
        public OthersViewModel(INavigationService navigationService, IEventAggregator ea) : base(navigationService)
        {
            _ea = ea;
            Initialize();
        }
        ...
        protected void Initialize()
        {
            ...
            {
                new SlideItem() { Icon ="icon-document",  PrimayText =TranslateManagerHelper.Convert("insurance").ToUpperInvariant(), Url="" }             
            };
            IsLoading = false;
        }
