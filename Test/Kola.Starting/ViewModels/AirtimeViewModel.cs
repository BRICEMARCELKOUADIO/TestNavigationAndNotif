...
{
    public class AirtimeViewModel : ViewModelBase
    {
        ...
        public AirtimeViewModel(INavigationService navigationService, IEventAggregator ea) : base(navigationService)
        {
            _ea = ea;
            Initialize();
        }
        ...
        protected void Initialize()
        {
            ...
            {
                new SlideItem() { Icon ="icon-pay_bills_internet",  PrimayText =TranslateManagerHelper.Convert("airtime").ToUpperInvariant(), Url="" },
                new SlideItem() { Icon ="icon-chart-bar",  PrimayText =TranslateManagerHelper.Convert("data").ToUpperInvariant(), Url="" },               
            };
            IsLoading = false;
        }
